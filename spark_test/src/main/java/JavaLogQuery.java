...
public final class JavaLogQuery {
  ...
  public static void main(String[] args) {
    ...
    // lambda type: (PairFunction<String, Tuple3<String, String, String>, Stats>)
    JavaPairRDD<Tuple3<String, String, String>, Stats> extracted = dataSet.mapToPair(
            s -> new Tuple2<>(extractKey(s), extractStats(s)));

    // lambda type - new Function2<Stats, Stats, Stats>()
    // Substituted lambda like (stats, stats2) -> stats.merge(stats2) to method reference Stats:merge
